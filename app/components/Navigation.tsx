        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            <div className="w-6 flex flex-col gap-1.5">
              <span className={`block h-px bg-[#f4f4f4] transition-all duration-300 ${isOpen ? 'rotate-45 translate-y-[4px]' : ''}`} />
              <span className={`block h-px bg-[#f4f4f4] transition-all duration-300 ${isOpen ? 'opacity-0' : ''}`} />
              <span className={`block h-px bg-[#f4f4f4] transition-all duration-300 ${isOpen ? '-rotate-45 -translate-y-[4px]' : ''}`} />
            </div>
          </button>
        </div>
